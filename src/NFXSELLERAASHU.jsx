...
// // Modal for user to enter their name
// const NameInputModal = ({ isOpen, onClose, onSave }) => {
...
//             <div className="bg-gray-800 p-6 rounded-lg shadow-xl max-w-sm w-full space-y-4">
//                 <h3 className="text-xl font-bold text-white text-center">Enter Your Name</h3>
//                 <input
//                     type="text"
//                     value={name}
//                     onChange={(e) => setName(e.target.value)}
//                     placeholder="e.g., Aashu"
//                     className="w-full p-3 rounded-lg bg-gray-700 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-amber-500"
//                 />
//                 <button
//                     onClick={handleSave}
//                     className="w-full bg-violet-600 hover:bg-violet-700 text-white font-bold py-3 rounded-lg transition-colors"
//                 >
//                     Save
//                 </button>
//             </div>
...
const WelcomeMessageModal = ({ isOpen, onClose, name }) => {
    if (!isOpen) return null;

    return (
        <div className="fixed inset-0 bg-gray-900 bg-opacity-75 flex items-center justify-center z-50">
            <div className="bg-gray-800 p-6 rounded-lg shadow-xl max-w-sm w-full space-y-4 text-center">
                <h3 className="text-2xl font-bold text-white">Hi, {name}!</h3>
                <button
                    onClick={onClose}
                    className="w-full bg-violet-600 hover:bg-violet-700 text-white font-bold py-3 rounded-lg transition-colors"
                >
...
// Navbar Component
const Navbar = ({ onProfileClick, cartItemCount, onCartClick, onHomeClick }) => {
    return (
        <nav className="flex items-center justify-between p-4 bg-indigo-900 fixed top-0 left-0 right-0 z-10">
            ...
            <div className="flex items-center space-x-6 text-sm">
                ...
                <button onClick={onProfileClick} className="text-amber-500 hover:text-amber-400 transition-colors duration-200 transition-transform hover:scale-105">
...
const App = () => {
    ...
    // Function to save user name to Firestore
    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen p-4 sm:p-8 bg-gray-900 text-white">
            ...
            <Navbar onProfileClick={handleProfileClick} cartItemCount={cartItemCount} onCartClick={() => togglePage('cart')} onHomeClick={() => togglePage('home')} />
